...
export const inventoryVehicles: InventoryVehicle[] = [
  ...
  },
  {
    ...
    stock: "RPT-338",
    status: "Available",
    accent: "rgba(34, 139, 230, 0.86)",
    summary:
      "Large family SUV positioned as a strong premium option for buyers who need space, comfort, and winter capability.",
    heroLabel: "Full Size SUV",
    category: "SUV",
    location: "Repete Auto · Vernal, Utah",
    badge: "3rd Row"
  },
  {
    slug: "2020-gmc-sierra-slt",
    year: "2020",
    make: "GMC",
    model: "Sierra 1500",
    trim: "SLT Crew Cab",
    ...
    stock: "RPT-287",
    status: "Available",
    accent: "rgba(184, 134, 11, 0.86)",
    summary:
      "Premium truck presence with a more upscale profile, built for towing, commuting, and local buyers wanting comfort.",
    heroLabel: "Premium Truck",
    category: "Truck",
    location: "Repete Auto · Vernal, Utah",
    badge: "Crew Cab"
  },
  {
    ...
    stock: "RPT-246",
    status: "Available",
    accent: "rgba(220, 20, 60, 0.84)",
    summary:
      "Clean sedan option that broadens the page visually and appeals to buyers who want efficiency and style.",
    heroLabel: "Daily Driver",
    category: "Car",
    location: "Repete Auto · Vernal, Utah",
    badge: "Sport"
  },
  {
    slug: "2018-nissan-altima-sr",
    year: "2018",
    make: "Nissan",
    model: "Altima",
    trim: "SR",
    ...
    stock: "RPT-231",
    status: "Available",
    accent: "rgba(255, 99, 71, 0.82)",
    summary:
      "Budget-conscious sedan tile that gives the grid realistic price variation and more used-lot breadth.",
    heroLabel: "Value Sedan",
    category: "Car",
    location: "Repete Auto · Vernal, Utah",
    badge: "Value"
  },
  {
    slug: "2017-jeep-wrangler-unlimited-sport",
    year: "2017",
    make: "Jeep",
    ...
    stock: "RPT-205",
    status: "Available",
    accent: "rgba(46, 139, 87, 0.84)",
    summary:
      "Rugged local-buyer favorite that adds strong visual character and reinforces the Basin-ready inventory identity.",
    heroLabel: "Trail Ready",
    category: "SUV",
    location: "Repete Auto · Vernal, Utah",
    badge: "4x4"
  },
  {
    slug: "2016-ford-explorer-xlt",
    year: "2016",
    make: "Ford",
    model: "Explorer",
    trim: "XLT",
    ...
    stock: "RPT-188",
    status: "Available",
    accent: "rgba(65, 105, 225, 0.82)",
    summary:
      "Affordable SUV option for family-oriented buyers who still want four-wheel-drive capability and utility.",
    heroLabel: "Family SUV",
    category: "SUV",
    location: "Repete Auto · Vernal, Utah",
    badge: "Affordable"
  }
